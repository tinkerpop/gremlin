...
h3. Version 1.5 (No More Mr. Nice Guy -- NOT OFFICIALLY RELEASED YET)
...
* Added @has@ and @hasNot@ step for concise property filtering (makes use of @PropertyFilterPipe@)
* Altered the semantics of @groupCount@ value function such that it now takes a @Pair@ (must more expressive)
* Updated @Imports.java@ to provide support for InfiniteGraph
