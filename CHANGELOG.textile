...
!http://github.com/tinkerpop/gremlin/raw/master/doc/images/gremlin-gremalicious.png!

h3. Version 0.6 (Gremalicious -- NOT OFFICIALLY RELEASED YET)
...
* Added anonymous step definitions using @/{ }/@ notation
...
** @g:add-aidx-key()@, @g:add-idx()@, @g:drop-idx()@, @g:show-aidx-keys()@, @g:show-idx()@
