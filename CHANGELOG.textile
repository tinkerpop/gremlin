...
h3. Version 0.3 (Gremalicious -- NOT OFFICIALLY RELEASED YET)
...
h3. Version 0.2.2 (Gremicide -- NOT OFFICIALLY RELEASED YET)
...
* Added dependency on Neo4j RDF and SAIL
* Added Neo4jSailGraph to the core distribution
* 
