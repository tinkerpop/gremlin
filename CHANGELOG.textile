...
* A complete redesign and implementation of the Gremlin compiler ("ANTLR-based":http://www.antlr.org/)
...
** All core functions are now in the @g@ namespace (e.g. @g:count()@)
