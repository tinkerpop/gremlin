...
** Compiler written using "ANTLR":http://www.antlr.org/ 3.2
** Virtual machine written using "Pipes":http://pipes.tinkerpop.com 0.1 and "JSR 223":http://jcp.org/en/jsr/detail?id=223.
...
** Added @g:includes()@ to determine if an object is an iterable
** Added @g:pow()@ to implement raising a number by a power
