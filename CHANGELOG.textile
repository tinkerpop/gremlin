...
h3. Version 2.0.0 (NOT OFFICIALLY RELEASED YET)
...
* Removed @OutPipe@, @InPipe@, and @BothPipe@ and replaced with @VerticesVerticesPipe@
* Removed @OutEdgesPipe@, @InEdgesPipe@, and @BothEdgesPipe@ and replaced with @VerticesEdgesPipe@
* Removed @OutVertexPipe@, @InVertexPipe@, and @BothVerticesPipe@ and replaced with @EdgesVerticesPipe@
...
* Provided @GremlinPipeline.optimize(boolean)@ to automatically optimize the pipeline
* Gremlin-Groovy
...
* Moved to the more optimal vertex/edge incident Pipes
