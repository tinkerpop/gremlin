...
h3. Version 1.2 (New Sheriff in Town -- NOT OFFICIALLY YET RELEASED)
...
* Added @Gremlin.version()@ to get version information
...
* Fixed the @aggregate@/@loop@ problem
* Migrated all pipes to "Pipes":http://pipes.tinkerpop.com
** Added @GroovyPipeClosure@ to map to @PipeClosure@
