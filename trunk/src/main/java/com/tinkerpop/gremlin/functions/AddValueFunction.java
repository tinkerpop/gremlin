...
public class AddValueFunction implements Function {
    ...
    public Object invoke(ExpressionContext context, Object[] parameters) {
        if (parameters != null && parameters.length == 3) {
            ...
            if (objects[0] instanceof Map && objects[2] instanceof Number) {
                ...
                addValue(map, objects[1], (Number) objects[2]);
    ...
    private static void addValue(Map map, Object key, Number amount) {
    ...
    private static void addValue(Element element, String key, Number amount) {
    ...
    private static void addValue(List list, Integer index, Number amount) {
