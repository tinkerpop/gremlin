...
Here are the steps to get Gremlin up and running. Either @git clone@ from @http://github.com/tinkerpop/gremlin.git@ and build the latest version of Gremlin (see [[Building Gremlin from Source]]) or you can download a pre-built version. For the latter, follow the steps below.
