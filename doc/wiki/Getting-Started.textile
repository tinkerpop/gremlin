...
==>e[11][4-created->3]
==>e[12][6-created->3]
gremlin> list._().inE{it.label=='knows'}     
==>e[7][1-knows->2]
gremlin> list.inE()[[label:'knows']]
==>e[7][1-knows->2]
gremlin> list._().inE('knows').outV.name
==>marko
gremlin> // toString() the pipeline to see what its composed of
gremlin> println list._().inE[[label:'knows']].outV.name
[IdentityPipe, InEdgesPipe, LabelFilterPipe<NOT_EQUAL,knows>, OutVertexPipe, PropertyPipe<name>]
==>null
