...
# edges
  ** followed_by (song x song): if the tail song was followed by the head song in concert.
    **** weight (integer): the number of times these two songs were paired in concert.
  ** sung_by (song x artist): if the tail song was primarily sung by the head artist.
  ** written_by (song x artist): if the tail song was written by the head artist.
