...
h2(#compile). Compiling Gremlin from Java
...
You can also compile pipelines (as well as evaluate more complex scripts) using the JSR 223 @GremlinScriptEngine@.

h2(#jsr223). An Introduction to JSR 223
