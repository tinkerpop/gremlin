...
* "Groovy":http://groovy.codehaus.org: The host language for Gremlin.
* "Blueprints":http://blueprints.tinkerpop.com: The library to interact with the underlying graph databases.
* "Pipes":http://pipes.tinkerpop.com: The library to lazily traverse a graph.
