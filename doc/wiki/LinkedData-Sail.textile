...
```text
gremlin> v.outE('foaf:made').inV.outE('dcterms:title').inV.value
...
```text
gremlin> v.outE{labels.contains(it.label)}.inV.outE('foaf:name').inV.value                                   
==>Heart of Gold Band
==>The Other Ones
==>Old & In the Way
==>7 Walkers
