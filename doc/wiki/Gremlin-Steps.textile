...
|_. step |_. filter? |_. description |_. pipe |
| @transform{closure}@ | no | emit the result of the closure | @ClosureTransformPipe(closure)@ |
...
| @outE@ | yes | the outgoing edges of the vertex | @OutEdgesPipe()@ |
| @inE@ | yes | the incoming edges of the vertex | @InEdgesPipe()@ |
| @bothE@ | yes | both incoming and outgoing edges of the vertex | @BothEdgesPipe()@ |
...
| @key@ | yes | get the property value of an element | @PropertyPipe(key)@ |
| @gather{closure?}@ | no | collect all objects up to that step and process with provided closure | @GatherPipe()@ and @ClosureTransformPipe(closure)@ |
...
| @outE('label')@ | yes | the outgoing label-edges of the vertex | @OutEdgesPipe('label')@ |
| @inE('label')@ | yes | the incoming label-edges of the vertex | @InEdgesPipe('label')@ |
| @bothE('label')@ | yes | both incoming and outgoing label-edges of the vertex | @BothEdgesPipe('label')@ |
...
|_. step |_. filter? |_. description |_. pipe |
| @sideEffect{closure}@ | no | emits the input, but calls a side effect closure on each input | @ClosureSideEffectPipe(closure)@ |
