...
| @out(label?)@ | yes | out adjacent vertices to the vertex | @OutPipe(label?)@ |
| @outE(label?)@ | yes | the outgoing edges of the vertex | @OutEdgesPipe(label?)@ |
| @in(label?)@ | yes | in adjacent vertices to the vertex | @InPipe(label?)@ |
| @inE(label?)@ | yes | the incoming edges of the vertex | @InEdgesPipe(label?)@ |
| @both(label?)@ | yes | both adjacent vertices of the vertex | @BothPipe(label?)@ |
| @bothE(label?)@ | yes | both incoming and outgoing edges of the vertex | @BothEdgesPipe(label?)@ |
