...
```text
gremlin> g.v('tg:1').outE[[label:g.uri('tg:knows')]].inV  
...
```text
gremlin> g.v('tg:1').outE[[label:g.uri('tg:knows')]].inV.outE[[label:g.uri('tg:name')]].inV  
...
```text
gremlin> g.v('tg:1').outE[[label:g.uri('tg:knows')]].inV.outE[[label:g.uri('tg:name')]].inV.value
==>vadas
==>josh
```
...
```text
gremlin> g.v('tg:1').outE[[label:g.uri('tg:knows')]].inV[[id:g.uri('tg:2')]].outE[[label:g.uri('tg:name')]].inV.value
==>vadas
```
