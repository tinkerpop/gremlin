...
```text
gremlin> g.v(89).out('followed_by').out('sung_by').has('name','Garcia').toString()             
...
```text
gremlin> g.v(89).out('followed_by').as('x').out('sung_by').has('name','Garcia').back('x').name.toString()
