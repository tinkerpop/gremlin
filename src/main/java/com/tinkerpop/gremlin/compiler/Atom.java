...
public class Atom {
	...
	public boolean isArray() {
		return isClassOf(ArrayList.class);
	}
	
	public boolean isMap() {
		return isClassOf(HashMap.class);
	}
	...
	private boolean isClassOf(final Class klass) {
		return (this.isNull()) ? false : ((this.val.getClass() == klass) ? true : false);
	}
